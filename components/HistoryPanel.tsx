...
export const WorkflowPanel: React.FC<WorkflowPanelProps> = ({ workflows, activeWorkflowId, onSelectWorkflow, onNewWorkflow, templates, onSelectTemplate, onRefresh, isRefreshing }) => {
  return (
